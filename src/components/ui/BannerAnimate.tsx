...
export default function BannerAnimate({ title }: { title: string }) {
    ...
    return (
        ...
        >
            <h1 className="text-white shadow-title font-luckiest banner-shadow animate-text-baner transition-all uppercase block tracking-wider mx-auto mt-5 m-7 text-md md:text-3xl text-center"
            >{title}
            </h1>
        </div>
    )
