...
export default function BannerAnumateCarrito() {
    return (
        ...
        >
            <h1 className="text-orange-dark shadow-title banner-shadow animate-text-baner transition-all uppercase block font-semibold tracking-wider font-luckiest mx-auto mt-5 m-7 text-xl md:text-4xl text-center"
